...
WHERE maas>=3000 and adi='Work'; -- and ve anlamına gelir 

SELECT * FROM Calisanlar
WHERE maas>=3000 or adi='Work'; -- or ya da anlamına gelir
...
INSERT INTO calisanlar (adi, soyadi, departman, maas) VALUES('ahsen', 'yılmaz', 'Yazılım', 13000);
INSERT INTO calisanlar (id, adi, soyadi) VALUES('ahsen','yılmaz' , 7000);
...
DELETE FROM WorkTable WHERE id=5;
...
-- çıktıda ahsen yılmaz gibi sonuçlar elde edilir.

-- SUBSTRİNG 

SELECT SUBSTRING('ahsen yılmaz', 1, 5); -- ahsen

-- LEFT

SELECT LEFT('ahsen yılmaz',5); -- ahsen

-- RİGHT

SELECT RIGHT('ahsen yılmaz',5); -- yılma

-- LOWER

SELECT LOWER('ahsen yılmaz'); -- Hepsini küçük harfe çevirdi

-- UPPER

SELECT UPPER('ahsen yılmaz'); -- Hepsini büyük yaptı

-- LENGTH yani LEN

SELECT LENGTH('ahsen yılmaz'); -- Kaç karakter olduğunu (karekter sayısını) bize verir

-- REPLACE

SELECT REPLACE('ahsen yılmaz', 'ahsen', 'yıl'); -- yıl yılmaz
-- REPLACE('değiştirelecek alan', 'alandaki değiştirelecek yer', 'ne olarak değiştirilecekse')

-- REVERSE

SELECT REVERSE('yılmaz'); -- zamlıy, tersine çevirir
